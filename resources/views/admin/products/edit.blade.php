            ...
            <form action="{{ route('admin.products.update', $product->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="number" class="form-control" id="price_3_days" name="price_3_days" value="{{ $product->price_3_days }}" required>
                    </div>

                    <div class="col-md-6">
                        <label for="price_over_3_days" class="form-label">Стоимость более 3 дней аренды, ₽</label>
                        <input type="number" class="form-control" id="price_over_3_days" name="price_over_3_days" value="{{ $product->price_over_3_days }}" required>
                    </div>
                </div>
